...
def get_financial_metrics(
    ...
    try:
        ...
        current_assets_t1 = balance_sheet.loc['Current Assets'].iloc[1] if 'Current Assets' in balance_sheet.index else None
        current_liabilities_t1 = balance_sheet.loc['Current Liabilities'].iloc[1] if 'Current Liabilities' in balance_sheet.index else None
        ...
        working_capital_current = current_assets - current_liabilities if current_assets is not None and current_liabilities is not None else None
        working_capital_previous = current_assets_t1 - current_liabilities_t1 if current_assets_t1 is not None and current_liabilities_t1 is not None else None
        ...
        metrics = {
            ...
            "working_capital_previous": working_capital_previous
        }
        return [metrics]
    ...
    try:
        ...
        try:
            data = {
                ...
                "property_plant_and_equipment": cash_flow.loc['Net PPE Purchase And Sale'].iloc[0] if 'Net PPE Purchase And Sale' in cash_flow.index else None, 
                ...
                "change_in_working_capital": cash_flow.loc['Change In Working Capital'].iloc[0] if 'Change In Working Capital' in cash_flow.index else None,
